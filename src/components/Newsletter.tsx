      ...
      <Container>
        <div className="relative -mx-4 overflow-hidden px-4 py-20 sm:-mx-6 sm:px-6 md:mx-0 md:rounded-5xl md:px-16 xl:px-24 xl:py-36">
          ...
          <div className="relative mx-auto grid max-w-2xl grid-cols-1 gap-x-32 gap-y-14 xl:max-w-none xl:grid-cols-2">
            <div>
              <p className="font-display text-4xl font-medium tracking-tighter text-[#2e2e2e] sm:text-5xl">
                Stay up to date
              </p>
            ...
            <form>
              <h3 className="text-lg font-semibold tracking-tight text-[#2e2e2e]">
                Sign up to our newsletter <span aria-hidden="true">&darr;</span>
              </h3>
              <div className="mt-5 flex rounded-3xl bg-white py-2.5 pr-2.5 shadow-xl shadow-[#2e2e2e]/5 focus-within:ring-2 focus-within:ring-[#2e2e2e]">
                <input
                  type="email"
                  required
